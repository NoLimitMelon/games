import {ac as Tt, j as F, a as yr} from "./index-BeQJxy4Y.js";
import {M as xr} from "./Icon-3Q1ZovIG.js";
function kr(e, n) {
    const t = {};
    ...
    en = function(b, z) {
        ...
        function B() {
            ...
            if (!(s != b.charAt(0) || u != b.charAt(1))) {
                for (var E = 2; p != b.charAt(E) && (u != b.charAt(E) || s != b.charAt(E + 1)); )
                    ++E;
                if (E += 2,
                p === b.charAt(E - 1))
...
class K extends Error {
    constructor(n, t, r) {
        ...
        typeof n == "string" ? i = n : !l.cause && n && (o = !0,
        i = n.message,
        l.cause = n),
        !l.ruleId && !l.source && typeof r == "string") {
            const c = r.indexOf(":");
            c === -1 ? l.ruleId = r : (l.source = r.slice(0, c),
            l.ruleId = r.slice(c + 1))
        }
...
function Xr(e, n, t) {
    const r = e.schema;
    let i = r;
    n.tagName.toLowerCase() === "svg" && r.space === "html" && (i = En,
    e.schema = i),
    e.ancestors.push(n);
    ...
    for (const r of n.attributes)
        if (r.type === "mdxJsxExpressionAttribute")
            if (r.data && r.data.estree && e.evaluater) {
                ...
                a.type,
                Object.assign(t, e.evaluater.evaluateExpression(a.argument))
            } else
                je(e, n.position);
        else {
            const i = r.name;
...
function ii(e, n, t) {
    ...
    if (!(t == null || typeof t == "number" && Number.isNaN(t))) {
        if (Array.isArray(t) && (t = r.commaSeparated ? kr(t) : _r(t)),
        r.property === "style") {
            let i = typeof t == "object" ? t : li(e, String(t));
            return e.stylePropertyNameCase === "css" && (i = oi(i)),
            ["style", i]
        }
...
function li(e, n) {
    try {
        ...
        i.url = Ft + "#cannot-parse-style-attribute",
        i
    }
}
function Bt(e, n, t) {
...
function je(e, n) {
    ...
    throw t.file = e.filePath || void 0,
    t.url = Ft + "#cannot-handle-mdx-estrees-without-createevaluater",
    t
}
function oi(e) {
    const n = {};
    let t;
    for (t in e)
        Tn.call(e, t) && (n[ai(t)] = e[t]);
    return n
}
function ai(e) {
    let n = e.replace(qr, ui);
    return n.slice(0, 3) === "ms-" && (n = "-" + n),
    n
}
function ui(e) {
    return "-" + e.toLowerCase()
...
function re(e, n) {
    return e.length > 0 ? (ce(e, e.length, 0, n),
    e) : n
}
...
function ze(e) {
    ...
    for (; ++t < e.length; ) {
        ...
        if (l === 37 && te(e.charCodeAt(t + 1)) && te(e.charCodeAt(t + 2)))
            ...
            l < 56320 && a > 56319 && a < 57344 ? (o = String.fromCharCode(l, a),
            i = 1) : o = "�"
        } else
            o = String.fromCharCode(l);
        o && (n.push(e.slice(r, t), encodeURIComponent(o)),
        r = t + i + 1,
        o = ""),
        i && (t += i,
        i = 0)
...
function q(e, n, t, r) {
    ...
    return o;
    function o(c) {
        return R(c) ? (e.enter(t),
        a(c)) : n(c)
    }
    function a(c) {
        return R(c) && l++ < i ? (e.consume(c),
        a) : (e.exit(t),
        n(c))
    }
}
...
function Ci(e) {
    ...
    function a(C) {
        if (r < t.length) {
            const j = t[r];
            return n.containerState = j[1],
            e.attempt(j[0].continuation, c, s)(C)
        }
        return s(C)
    }
    function c(C) {
        ...
        n.containerState._closeFlow) {
            ...
            for (; _ < n.events.length; )
                ...
                _++;
            return ce(n.events, U + 1, 0, n.events.slice(j)),
            n.events.length = _,
            s(C)
        }
        return a(C)
    ...
    function S(C) {
        ...
        return i = i || n.parser.flow(n.now()),
        e.enter("chunkFlow", {
            _tokenizer: i,
            contentType: "flow",
            previous: l
    ...
    function z(C, j) {
        ...
        n.parser.lazy[C.start.line]) {
            ...
            for (; y--; )
                if (i.events[y][1].start.offset < o && (!i.events[y][1].end || i.events[y][1].end.offset > o))
                    return;
            ...
            for (k(r),
            y = _; y < n.events.length; )
                n.events[y][1].end = {
                    ...B
                },
                y++;
            ce(n.events, $ + 1, 0, n.events.slice(_)),
            n.events.length = y
        }
    }
    function k(C) {
        ...
        if (e[t][0] === "enter" && e[t][1].type === "attentionSequence" && e[t][1]._close) {
            for (r = t; r--; )
                if (e[r][0] === "exit" && e[r][1].type === "attentionSequence" && e[r][1]._open && n.sliceSerialize(e[r][1]).charCodeAt(0) === n.sliceSerialize(e[t][1]).charCodeAt(0)) {
                    ...
                    s = [],
                    e[r][1].end.offset - e[r][1].start.offset && (s = re(s, [["enter", e[r][1], n], ["exit", e[r][1], n]])),
                    s = re(s, [["enter", i, n], ["enter", o, n], ["exit", o, n], ["enter", l, n]]),
                    s = re(s, Ln(n.parser.constructs.insideSpan.null, e.slice(r + 1, t), n)),
                    s = re(s, [["exit", l, n], ["enter", a, n], ["exit", a, n], ["exit", i, n]]),
                    e[t][1].end.offset - e[t][1].start.offset ? (u = 2,
                    s = re(s, [["enter", e[t][1], n], ["exit", e[t][1], n]])) : u = 0,
                    ce(e, r - 1, t - r + 3, s),
                    t = r + s.length - u - 2;
                    break
                }
...
function Ti(e, n) {
    ...
    function a(c) {
        ...
        return s._open = !!(l === 42 ? p : p && (i || !d)),
        s._close = !!(l === 42 ? d : d && (u || !p)),
        n(c)
    }
}
function rt(e, n) {
...
function Ai(e, n, t) {
    ...
    function l(f) {
        return se(f) ? (e.consume(f),
        o) : f === 64 ? t(f) : s(f)
    }
    function o(f) {
        return f === 43 || f === 45 || f === 46 || te(f) ? (r = 1,
        a(f)) : s(f)
    }
    function a(f) {
        return f === 58 ? (e.consume(f),
        r = 0,
        c) : (f === 43 || f === 45 || f === 46 || te(f)) && r++ < 32 ? (e.consume(f),
        a) : (r = 0,
        s(f))
    }
    function c(f) {
        return f === 62 ? (e.exit("autolinkProtocol"),
        e.enter("autolinkMarker"),
        e.consume(f),
        e.exit("autolinkMarker"),
        e.exit("autolink"),
        n) : f === null || f === 32 || f === 60 || yn(f) ? t(f) : (e.consume(f),
        c)
    }
    function s(f) {
        return f === 64 ? (e.consume(f),
        u) : di(f) ? (e.consume(f),
        s) : t(f)
    }
    function u(f) {
    ...
    function p(f) {
        return f === 46 ? (e.consume(f),
        r = 0,
        u) : f === 62 ? (e.exit("autolinkProtocol").type = "autolinkEmail",
        e.enter("autolinkMarker"),
        e.consume(f),
        e.exit("autolinkMarker"),
        e.exit("autolink"),
...
function Li(e, n, t) {
    ...
    function l(o) {
        return R(o) ? (e.enter("blockQuotePrefixWhitespace"),
        e.consume(o),
...
function Di(e, n, t) {
    ...
    function i(l) {
        return yi(l) ? (e.enter("characterEscapeValue"),
        e.consume(l),
...
function Oi(e, n, t) {
    ...
    function c(p) {
        return p === 35 ? (e.enter("characterReferenceMarkerNumeric"),
        e.consume(p),
    ...
    function s(p) {
        return p === 88 || p === 120 ? (e.enter("characterReferenceMarkerHexadecimal"),
        e.consume(p),
    ...
    function u(p) {
        if (p === 59 && i) {
            ...
            return o === te && !zn(r.sliceSerialize(d)) ? t(p) : (e.enter("characterReferenceMarker"),
            e.consume(p),
            e.exit("characterReferenceMarker"),
            e.exit("characterReference"),
            n)
        }
        return o(p) && i++ < l ? (e.consume(p),
        u) : t(p)
    }
}
const it = {
...
function _i(e, n, t) {
    ...
    function s(y) {
        ...
        return l = _ && _[1].type === "linePrefix" ? _[2].sliceSerialize(_[1], !0).length : 0,
        a = y,
        e.enter("codeFenced"),
    ...
    function u(y) {
        return y === a ? (o++,
        e.consume(y),
        u) : o < 3 ? t(y) : (e.exit("codeFencedFenceSequence"),
        R(y) ? q(e, p, "whitespace")(y) : p(y))
    }
    function p(y) {
        return y === null || L(y) ? (e.exit("codeFencedFence"),
        r.interrupt ? n(y) : e.check(it, b, j)(y)) : (e.enter("codeFencedFenceInfo"),
        e.enter("chunkString", {
            contentType: "string"
        }),
        d(y))
    ...
    function d(y) {
        return y === null || L(y) ? (e.exit("chunkString"),
        e.exit("codeFencedFenceInfo"),
        p(y)) : R(y) ? (e.exit("chunkString"),
        e.exit("codeFencedFenceInfo"),
        q(e, f, "whitespace")(y)) : y === 96 && y === a ? t(y) : (e.consume(y),
        d)
    }
    function f(y) {
        return y === null || L(y) ? p(y) : (e.enter("codeFencedFenceMeta"),
        e.enter("chunkString", {
            contentType: "string"
        }),
        S(y))
    ...
    function A(y) {
        return y === null || L(y) ? e.check(it, b, j)(y) : (e.enter("codeFlowValue"),
        C(y))
    }
    function C(y) {
    ...
    function U(y, _, $) {
        ...
        function P(N) {
            ...
            R(N) ? q(y, I, "linePrefix", r.parser.constructs.disable.null.includes("codeIndented") ? void 0 : 4)(N) : I(N)
        }
        function I(N) {
            return N === a ? (y.enter("codeFencedFenceSequence"),
            T(N)) : $(N)
        }
        function T(N) {
            return N === a ? (M++,
            y.consume(N),
            T) : M >= o ? (y.exit("codeFencedFenceSequence"),
            R(N) ? q(y, E, "whitespace")(N) : E(N)) : $(N)
        }
        function E(N) {
            return N === null || L(N) ? (y.exit("codeFencedFence"),
            _(N)) : $(N)
        }
    }
}
function Fi(e, n, t) {
    ...
    return i;
    function i(o) {
        return o === null ? t(o) : (e.enter("lineEnding"),
        e.consume(o),
        e.exit("lineEnding"),
        l)
    }
...
function Mi(e, n, t) {
    ...
    function o(s) {
        return s === null ? c(s) : L(s) ? e.attempt(Ri, o, c)(s) : (e.enter("codeFlowValue"),
        a(s))
    }
    function a(s) {
        return s === null || L(s) ? (e.exit("codeFlowValue"),
        o(s)) : (e.consume(s),
        a)
    }
    function c(s) {
...
function Bi(e, n, t) {
    ...
    return i;
    function i(o) {
        return r.parser.lazy[r.now().line] ? t(o) : L(o) ? (e.enter("lineEnding"),
        e.consume(o),
        e.exit("lineEnding"),
        i) : q(e, l, "linePrefix", 5)(o)
    }
    function l(o) {
...
function Hi(e) {
    ...
    for (r = t - 1,
    n++; ++r <= n; )
        i === void 0 ? r !== n && e[r][1].type !== "lineEnding" && (i = r) : (r === n || e[r][1].type === "lineEnding") && (e[i][1].type = "codeTextData",
...
function Vi(e, n, t) {
    ...
    function a(p) {
        return p === 96 ? (e.consume(p),
        r++,
        a) : (e.exit("codeTextSequence"),
        c(p))
    }
    function c(p) {
        return p === null ? t(p) : p === 32 ? (e.enter("space"),
        e.consume(p),
        e.exit("space"),
        c) : p === 96 ? (l = e.enter("codeTextSequence"),
        i = 0,
        u(p)) : L(p) ? (e.enter("lineEnding"),
        e.consume(p),
        e.exit("lineEnding"),
    ...
    function s(p) {
        return p === null || p === 32 || p === 96 || L(p) ? (e.exit("codeTextData"),
        c(p)) : (e.consume(p),
        s)
    }
    function u(p) {
...
function $t(e) {
    ...
    for (; ++t < u.length; ) {
        for (; t in n; )
            t = n[t];
        if (r = u.get(t),
        t && r[1].type === "chunkFlow" && u.get(t - 1)[1].type === "listItemPrefix" && (c = r[1]._tokenizer.events,
        l = 0,
        l < c.length && c[l][1].type === "lineEndingBlank" && (l += 2),
        l < c.length && c[l][1].type === "content"))
            for (; ++l < c.length && c[l][1].type !== "content"; )
                c[l][1].type === "chunkText" && (c[l][1]._isInFirstContentOfListItem = !0,
                l++);
        if (r[0] === "enter")
            r[1].contentType && (Object.assign(n, $i(u, t)),
            t = n[t],
            s = !0);
    ...
    return ce(e, 0, Number.POSITIVE_INFINITY, u.slice(0)),
    !s
}
function $i(e, n) {
    const t = e.get(n)[1]
    ...
    const l = [];
    let o = t._tokenizer;
    o || (o = r.parser[t.contentType](t.start),
    t._contentTypeTextTrailing && (o._contentTypeTextTrailing = !0));
    const a = o.events
      , c = []
      , s = {};
    let u, p, d = -1, f = t, S = 0, b = 0;
    const z = [b];
    for (; f; ) {
        for (; e.get(++i)[1] !== f; )
            ;
    ...
    f.previous = void 0) : z.pop(),
    d = z.length; d--; ) {
        const k = a.slice(z[d], z[d + 1])
          , A = l.pop();
        c.push([A, A + k.length - 1]),
        e.splice(A, 2, k)
    }
    for (c.reverse(),
    d = -1; ++d < c.length; )
...
function Qi(e, n) {
    ...
    function i(a) {
        return a === null ? l(a) : L(a) ? e.check(Yi, o, l)(a) : (e.consume(a),
        i)
    }
    function l(a) {
...
function Wt(e, n, t, r, i, l, o, a, c) {
    ...
    return p;
    function p(k) {
        return k === 60 ? (e.enter(r),
        e.enter(i),
        e.enter(l),
        e.consume(k),
        e.exit(l),
        d) : k === null || k === 32 || k === 41 || yn(k) ? t(k) : (e.enter(r),
        e.enter(o),
        e.enter(a),
        e.enter("chunkString", {
            contentType: "string"
    ...
    function f(k) {
        return k === 62 ? (e.exit("chunkString"),
        e.exit(a),
        d(k)) : k === null || k === 60 || L(k) ? t(k) : (e.consume(k),
        k === 92 ? S : f)
    }
    function S(k) {
        return k === 60 || k === 62 || k === 92 ? (e.consume(k),
        f) : f(k)
    }
    function b(k) {
        return !u && (k === null || k === 41 || J(k)) ? (e.exit("chunkString"),
        e.exit(a),
        e.exit(o),
        e.exit(r),
        n(k)) : u < s && k === 40 ? (e.consume(k),
        u++,
        b) : k === 41 ? (e.consume(k),
        u--,
        b) : k === null || k === 32 || k === 40 || yn(k) ? t(k) : (e.consume(k),
        k === 92 ? z : b)
    }
    function z(k) {
        return k === 40 || k === 41 || k === 92 ? (e.consume(k),
        b) : b(k)
    }
}
function Yt(e, n, t, r, i, l) {
    ...
    function u(f) {
        return a > 999 || f === null || f === 91 || f === 93 && !c || f === 94 && !a && "_hiddenFootnoteSupport"in o.parser.constructs ? t(f) : f === 93 ? (e.exit(l),
        e.enter(i),
        e.consume(f),
        e.exit(i),
        e.exit(r),
        n) : L(f) ? (e.enter("lineEnding"),
        e.consume(f),
        e.exit("lineEnding"),
    ...
    function p(f) {
        return f === null || f === 91 || f === 93 || L(f) || a++ > 999 ? (e.exit("chunkString"),
        u(f)) : (e.consume(f),
        c || (c = !R(f)),
        f === 92 ? d : p)
    }
    function d(f) {
        return f === 91 || f === 92 || f === 93 ? (e.consume(f),
        a++,
        p) : p(f)
    }
}
function Xt(e, n, t, r, i, l) {
    ...
    function s(d) {
        return d === o ? (e.exit(l),
        c(o)) : d === null ? t(d) : L(d) ? (e.enter("lineEnding"),
        e.consume(d),
        e.exit("lineEnding"),
        q(e, s, "linePrefix")) : (e.enter("chunkString", {
            contentType: "string"
        }),
        u(d))
    }
    function u(d) {
        return d === o || d === null || L(d) ? (e.exit("chunkString"),
        s(d)) : (e.consume(d),
        d === 92 ? p : u)
    }
    function p(d) {
        return d === o || d === 92 ? (e.consume(d),
        u) : u(d)
    }
}
function Me(e, n) {
    ...
    return r;
    function r(i) {
        return L(i) ? (e.enter("lineEnding"),
        e.consume(i),
        e.exit("lineEnding"),
        t = !0,
        r) : R(i) ? q(e, r, t ? "linePrefix" : "lineSuffix")(i) : n(i)
    }
}
const Gi = {
    name: "definition",
...
function Zi(e, n, t) {
    ...
    function a(f) {
        return i = Pe(r.sliceSerialize(r.events[r.events.length - 1][1]).slice(1, -1)),
        f === 58 ? (e.enter("definitionMarker"),
        e.consume(f),
    ...
    function d(f) {
        return f === null || L(f) ? (e.exit("definition"),
...
function tl(e, n, t) {
    ...
    function i(l) {
        return L(l) ? (e.exit("hardBreakEscape"),
        n(l)) : t(l)
    }
}
const rl = {
...
function il(e, n) {
    ...
    e[t][1].type === "atxHeadingSequence" && (r === t - 1 || t - 4 > r && e[t - 2][1].type === "whitespace") && (t -= r + 1 === t ? 2 : 4),
    t > r && (i = {
        type: "atxHeadingText",
        start: e[r][1].start,
        end: e[t][1].end
    ...
    ce(e, r, t - r + 1, [["enter", i, n], ["enter", l, n], ["exit", l, n], ["exit", i, n]])),
    e
}
function ll(e, n, t) {
    let r = 0;
    ...
    function o(u) {
        return u === 35 && r++ < 6 ? (e.consume(u),
        o) : u === null || J(u) ? (e.exit("atxHeadingSequence"),
        a(u)) : t(u)
    }
    function a(u) {
        return u === 35 ? (e.enter("atxHeadingSequence"),
        c(u)) : u === null || L(u) ? (e.exit("atxHeading"),
        n(u)) : R(u) ? q(e, a, "whitespace")(u) : (e.enter("atxHeadingText"),
        s(u))
    }
    function c(u) {
        return u === 35 ? (e.consume(u),
        c) : (e.exit("atxHeadingSequence"),
        a(u))
    }
    function s(u) {
        return u === null || u === 35 || J(u) ? (e.exit("atxHeadingText"),
        a(u)) : (e.consume(u),
        s)
    }
}
...
function cl(e) {
    ...
    for (; n-- && !(e[n][0] === "enter" && e[n][1].type === "htmlFlow"); )
        ;
    return n > 1 && e[n - 2][1].type === "linePrefix" && (e[n][1].start = e[n - 2][1].start,
...
function pl(e, n, t) {
    ...
    function p(m) {
        ...
        b) : m === 63 ? (e.consume(m),
        i = 3,
        r.interrupt ? n : h) : se(m) ? (e.consume(m),
    ...
    function S(m) {
        const oe = "CDATA[";
        return m === oe.charCodeAt(a++) ? (e.consume(m),
        a === oe.length ? r.interrupt ? n : I : S) : t(m)
    }
    function b(m) {
        return se(m) ? (e.consume(m),
        o = String.fromCharCode(m),
        z) : t(m)
    }
    function z(m) {
        if (m === null || m === 47 || m === 62 || J(m)) {
            const oe = m === 47
              , xe = o.toLowerCase();
            return !oe && !l && ot.includes(xe) ? (i = 1,
            r.interrupt ? n(m) : I(m)) : ol.includes(o.toLowerCase()) ? (i = 6,
            oe ? (e.consume(m),
            k) : r.interrupt ? n(m) : I(m)) : (i = 7,
            r.interrupt && !r.parser.lazy[r.now().line] ? t(m) : l ? A(m) : C(m))
        }
        return m === 45 || te(m) ? (e.consume(m),
        o += String.fromCharCode(m),
        z) : t(m)
    }
    function k(m) {
    ...
    function A(m) {
        return R(m) ? (e.consume(m),
        A) : B(m)
    }
    function C(m) {
        return m === 47 ? (e.consume(m),
        B) : m === 58 || m === 95 || se(m) ? (e.consume(m),
        j) : R(m) ? (e.consume(m),
        C) : B(m)
    }
    function j(m) {
        return m === 45 || m === 46 || m === 58 || m === 95 || te(m) ? (e.consume(m),
        j) : U(m)
    }
    function U(m) {
    ...
    function y(m) {
        return m === null || m === 60 || m === 61 || m === 62 || m === 96 ? t(m) : m === 34 || m === 39 ? (e.consume(m),
        c = m,
        _) : R(m) ? (e.consume(m),
        y) : $(m)
    }
    function _(m) {
        return m === c ? (e.consume(m),
        c = null,
        M) : m === null || L(m) ? t(m) : (e.consume(m),
        _)
    }
    function $(m) {
    ...
    function P(m) {
        return m === null || L(m) ? I(m) : R(m) ? (e.consume(m),
        P) : t(m)
    }
    function I(m) {
        return m === 45 && i === 2 ? (e.consume(m),
        Y) : m === 60 && i === 1 ? (e.consume(m),
        X) : m === 62 && i === 4 ? (e.consume(m),
        le) : m === 63 && i === 3 ? (e.consume(m),
        h) : m === 93 && i === 5 ? (e.consume(m),
        pe) : L(m) && (i === 6 || i === 7) ? (e.exit("htmlFlowData"),
        e.check(ul, fe, T)(m)) : m === null || L(m) ? (e.exit("htmlFlowData"),
        T(m)) : (e.consume(m),
        I)
    }
    function T(m) {
    ...
    function N(m) {
        return m === null || L(m) ? T(m) : (e.enter("htmlFlowData"),
        I(m))
    }
    function Y(m) {
        return m === 45 ? (e.consume(m),
    ...
    function ie(m) {
        if (m === 62) {
            ...
            return ot.includes(oe) ? (e.consume(m),
            le) : I(m)
        }
        return se(m) && o.length < 8 ? (e.consume(m),
        o += String.fromCharCode(m),
        ie) : I(m)
    }
    function pe(m) {
    ...
    function h(m) {
        return m === 62 ? (e.consume(m),
        le) : m === 45 && i === 2 ? (e.consume(m),
        h) : I(m)
    }
    function le(m) {
        return m === null || L(m) ? (e.exit("htmlFlowData"),
        fe(m)) : (e.consume(m),
        le)
    }
    function fe(m) {
...
function dl(e, n, t) {
    ...
    function p(h) {
        return h === null ? t(h) : h === 45 ? (e.consume(h),
        d) : L(h) ? (o = p,
        X(h)) : (e.consume(h),
        p)
    }
    ...
    function S(h) {
        const le = "CDATA[";
        return h === le.charCodeAt(l++) ? (e.consume(h),
        l === le.length ? b : S) : t(h)
    }
    function b(h) {
    ...
    function k(h) {
        return h === 62 ? Y(h) : h === 93 ? (e.consume(h),
        k) : b(h)
    }
    function A(h) {
        return h === null || h === 62 ? Y(h) : L(h) ? (o = A,
        X(h)) : (e.consume(h),
        A)
    }
    function C(h) {
        return h === null ? t(h) : h === 63 ? (e.consume(h),
        j) : L(h) ? (o = C,
        X(h)) : (e.consume(h),
        C)
    }
    ...
    function U(h) {
        return se(h) ? (e.consume(h),
        y) : t(h)
    }
    function y(h) {
        return h === 45 || te(h) ? (e.consume(h),
        y) : _(h)
    }
    function _(h) {
        return L(h) ? (o = _,
    ...
    function $(h) {
        return h === 45 || te(h) ? (e.consume(h),
        $) : h === 47 || h === 62 || J(h) ? M(h) : t(h)
    }
    function M(h) {
        return h === 47 ? (e.consume(h),
        Y) : h === 58 || h === 95 || se(h) ? (e.consume(h),
        B) : L(h) ? (o = M,
        X(h)) : R(h) ? (e.consume(h),
        M) : Y(h)
    }
    function B(h) {
        return h === 45 || h === 46 || h === 58 || h === 95 || te(h) ? (e.consume(h),
        B) : P(h)
    }
    function P(h) {
    ...
    function I(h) {
        return h === null || h === 60 || h === 61 || h === 62 || h === 96 ? t(h) : h === 34 || h === 39 ? (e.consume(h),
        i = h,
        T) : L(h) ? (o = I,
        X(h)) : R(h) ? (e.consume(h),
        I) : (e.consume(h),
    ...
    function T(h) {
        return h === i ? (e.consume(h),
        i = void 0,
        N) : h === null ? t(h) : L(h) ? (o = T,
        X(h)) : (e.consume(h),
        T)
    }
    function E(h) {
        return h === null || h === 34 || h === 39 || h === 60 || h === 61 || h === 96 ? t(h) : h === 47 || h === 62 || J(h) ? M(h) : (e.consume(h),
        E)
    }
    function N(h) {
...
function kl(e) {
    ...
    return e.length !== t.length && ce(e, 0, e.length, t),
    e
}
function bl(e, n) {
    ...
    for (; t--; )
        ...
        l) {
            ...
            if (e[t][0] === "enter" && (i.type === "labelImage" || i.type === "labelLink") && !i._balanced && (l = t,
            i.type !== "labelLink")) {
                r = 2;
                break
            }
    ...
    return a = [["enter", c, n], ["enter", s, n]],
    a = re(a, e.slice(l + 1, l + r + 3)),
    a = re(a, [["enter", u, n]]),
    a = re(a, Ln(n.parser.constructs.insideSpan.null, e.slice(l + r + 4, o - 3), n)),
    a = re(a, [["exit", u, n], e[o - 2], e[o - 1], ["exit", s, n]]),
    a = re(a, e.slice(o + 1)),
    a = re(a, [["exit", c, n]]),
    ce(e, l, e.length, a),
    e
...
function Sl(e, n, t) {
    ...
    function u(p) {
        return p === 41 ? (e.enter("resourceMarker"),
        e.consume(p),
        e.exit("resourceMarker"),
        e.exit("resource"),
        n) : t(p)
...
function El(e, n, t) {
    ...
    function i(l) {
        return l === 93 ? (e.enter("referenceMarker"),
        e.consume(l),
        e.exit("referenceMarker"),
        e.exit("reference"),
        n) : t(l)
...
function Tl(e, n, t) {
    ...
    function l(a) {
        return a === 91 ? (e.enter("labelMarker"),
        e.consume(a),
        e.exit("labelMarker"),
        e.exit("labelImage"),
        o) : t(a)
...
function Ll(e, n, t) {
    ...
    function a(s) {
        return s === i ? (e.enter("thematicBreakSequence"),
        c(s)) : r >= 3 && (s === null || L(s)) ? (e.exit("thematicBreak"),
        n(s)) : t(s)
    }
    function c(s) {
        return s === i ? (e.consume(s),
        r++,
        c) : (e.exit("thematicBreakSequence"),
        R(s) ? q(e, a, "whitespace")(s) : a(s))
    }
}
const G = {
    continuation: {
...
function Dl(e, n, t) {
    ...
    function a(f) {
        ...
        if (S === "listUnordered" ? !r.containerState.marker || f === r.containerState.marker : xn(f)) {
            if (r.containerState.type || (r.containerState.type = S,
            e.enter(S, {
                _container: !0
            })),
            S === "listUnordered")
                return e.enter("listItemPrefix"),
                f === 42 || f === 45 ? e.check(Ye, t, s)(f) : s(f);
            if (!r.interrupt || f === 49)
                return e.enter("listItemPrefix"),
    ...
    function c(f) {
        return xn(f) && ++o < 10 ? (e.consume(f),
        c) : (!r.interrupt || o < 2) && (r.containerState.marker ? f === r.containerState.marker : f === 41 || f === 46) ? (e.exit("listItemValue"),
        s(f)) : t(f)
    }
    function s(f) {
        ...
        e.check(Ke, r.interrupt ? t : u, e.attempt(Nl, d, p))
    }
    function u(f) {
    ...
    function p(f) {
        return R(f) ? (e.enter("listItemPrefixWhitespace"),
        e.consume(f),
        e.exit("listItemPrefixWhitespace"),
        d) : t(f)
    }
    function d(f) {
        return r.containerState.size = l + r.sliceSerialize(e.exit("listItemPrefix"), !0).length,
        n(f)
    }
}
function Ol(e, n, t) {
    ...
    function l(a) {
        return r.containerState.furtherBlankLines || !R(a) ? (r.containerState.furtherBlankLines = void 0,
    ...
    function o(a) {
        ...
        r.interrupt = void 0,
        q(e, e.attempt(G, n, t), "linePrefix", r.parser.constructs.disable.null.includes("codeIndented") ? void 0 : 4)(a)
    }
}
function _l(e, n, t) {
    const r = this;
...
function Bl(e, n, t) {
    ...
    function l(s) {
        ...
        return !r.parser.lazy[r.now().line] && (r.interrupt || p) ? (e.enter("setextHeadingLine"),
        i = s,
        o(s)) : t(s)
    }
    function o(s) {
    ...
    function a(s) {
        return s === i ? (e.consume(s),
        a) : (e.exit("setextHeadingLineSequence"),
        R(s) ? q(e, c, "lineSuffix")(s) : c(s))
    }
    function c(s) {
        return s === null || L(s) ? (e.exit("setextHeadingLine"),
        n(s)) : t(s)
    }
}
const jl = {
...
function Kt(e) {
    ...
    function n(t, r) {
        let i = -1, l;
        for (; ++i <= t.length; )
            l === void 0 ? t[i] && t[i][1].type === "data" && (l = i,
            i++) : (!t[i] || t[i][1].type !== "data") && (i !== l + 2 && (t[l][1].end = t[i - 1][1].end,
            t.splice(l + 2, i - l - 2),
            i = l + 2),
            l = void 0);
        return e ? e(t, r) : t
    ...
    for (; ++t <= e.length; )
        if ((t === e.length || e[t][1].type === "lineEnding") && e[t - 1][1].type === "data") {
            ...
            a) {
                ...
                r.start.offset === r.end.offset ? Object.assign(r, s) : (e.splice(t, 0, ["enter", s, n], ["exit", s, n]),
                t += 2)
            }
            t++
        }
...
function to(e, n, t) {
    ...
    return n.resolveAll && l.push(n),
    s;
    function p(P) {
        return o = re(o, P),
        z(),
        o[o.length - 1] !== null ? [] : ($(n, 0),
        s.events = Ln(l, s.events, s),
        s.events)
    }
    function d(P, I) {
        return io(f(P), I)
    ...
    function S() {
        const {_bufferIndex: P, _index: I, line: T, column: E, offset: N} = r;
        return {
            _bufferIndex: P,
            _index: I,
            line: T,
    ...
    function z() {
        ...
        for (; r._index < o.length; ) {
            ...
            if (typeof I == "string")
                for (P = r._index,
                r._bufferIndex < 0 && (r._bufferIndex = 0); r._index === P && r._bufferIndex < I.length; )
        ...
        function T(E, N, Y) {
            ...
            function m(Q) {
                ...
                function Le(de) {
                    ...
                    Q.name && s.parser.constructs.disable.null.includes(Q.name) ? xe() : Q.tokenize.call(I ? Object.assign(Object.create(s), I) : s, c, oe, xe)(de)
                }
            }
            function oe(Q) {
                return P(pe, h),
            ...
            function xe(Q) {
                return h.restore(),
                ++ie < X.length ? m(X[ie]) : Y
            }
        }
    }
    function $(P, I) {
        P.resolveAll && !l.includes(P) && l.push(P),
        P.resolve && ce(s.events, I, s.events.length - I, P.resolve(s.events.slice(I), s)),
...
function ao() {
    ...
    function i(l, o, a) {
        const c = [];
        let s, u, p, d, f;
        for (l = n + (typeof l == "string" ? l.toString() : new TextDecoder(o || void 0).decode(l)),
        p = 0,
        n = "",
        t && (l.charCodeAt(0) === 65279 && p++,
        t = void 0); p < l.length; ) {
            if (ut.lastIndex = p,
            s = ut.exec(l),
            d = s && s.index !== void 0 ? s.index : l.length,
            f = l.charCodeAt(d),
            !s) {
                n = l.slice(p);
                break
...
function po(e, n, t) {
    ...
    n = void 0),
    fo(t)(oo(lo(t).document().write(ao()(e, n, !0))))
}
function fo(e) {
    const n = {
        transforms: [],
    ...
    function r(g) {
        ...
        H = -1; ++H < n.transforms.length; )
            w = n.transforms[H](w) || w;
        return w
    }
    function i(g, w, v) {
        let O = w - 1, H = -1, ae = !1, ke, he, Ne, ve;
        for (; ++O <= v; ) {
            const ee = g[O];
            switch (ee[1].type) {
            case "listUnordered":
                ...
                if (ke) {
                    ...
                    for (he = void 0; Ce--; ) {
                        ...
                        if (me[1].type === "lineEnding" || me[1].type === "lineEndingBlank") {
                            if (me[0] === "exit")
                                continue;
                            he && (g[he][1].type = "lineEndingBlank",
                            ae = !0),
                            me[1].type = "lineEnding",
                            he = Ce
                        } else if (!(me[1].type === "linePrefix" || me[1].type === "blockQuotePrefix" || me[1].type === "blockQuotePrefixWhitespace" || me[1].type === "blockQuoteMarker" || me[1].type === "listItemIndent"))
                            break
                    }
                    Ne && (!he || Ne < he) && (ke._spread = !0),
                    ke.end = Object.assign({}, he ? g[he][1].start : ee[1].end),
                    g.splice(he || O, 0, ["exit", ke, ee[2]]),
                    O++,
                    v++
                }
    ...
    function a(g, w, v) {
        ...
        this.stack.push(g),
        this.tokenStack.push([w, v || void 0]),
        g.position = {
            start: ge(w.start),
            end: void 0
        }
    ...
    function s(g, w) {
        ...
        if (O)
            O[0].type !== g.type && (w ? w.call(this, g, O[0]) : (O[1] || st).call(this, g, O[0]));
        else
            throw new Error("Cannot close `" + g.type + "` (" + Re({
                start: g.start,
                end: g.end
            }) + "): it’s not open");
    ...
    function A(g) {
        ...
        v.label = w,
        v.identifier = Pe(this.sliceSerialize(g)).toLowerCase()
    }
    function C() {
        const g = this.resume()
          , w = this.stack[this.stack.length - 1];
    ...
    function P(g) {
        ...
        !this.data.setextHeadingSlurpLineEnding && n.canContainEols.includes(w.type) && (M.call(this, g),
        B.call(this, g))
    }
    function I() {
    ...
    function Q(g) {
        ...
        let O;
        v ? (O = Ht(w, v === "characterReferenceMarkerNumeric" ? 10 : 16),
        this.data.characterReferenceType = void 0) : O = zn(w);
...
function wo(e, n) {
    ...
    o = e.footnoteOrder.length) : o = l + 1,
    a += 1,
...
function Zt(e, n) {
    ...
    let r = "]";
    if (t === "collapsed" ? r += "[]" : t === "full" && (r += "[" + (n.label || n.identifier) + "]"),
...
function zo(e, n, t) {
    ...
    if (typeof n.checked == "boolean") {
        ...
        r.unshift(p)),
        p.children.length > 0 && p.children.unshift({
            type: "text",
            value: " "
        }),
        p.children.unshift({
...
function Mo(e) {
    ...
    const l = [];
    for (; r; )
        l.push(ft(n.slice(i, r.index), i > 0, !0), r[0]),
        i = r.index + r[0].length,
        r = t.exec(n);
    return l.push(ft(n.slice(i), i > 0, !1)),
    l.join("")
}
function ft(e, n, t) {
    let r = 0
        ...
        case Be:
            {
                if (c) {
                    let d = o;
                    return c === "DataView" ? d = new Uint8Array(o.buffer) : c === "ArrayBuffer" && (d = new Uint8Array(o)),
                    i([c, [...d]], o)
                }
                const u = []
                  , p = i([a, u], o);
        ...
        case On:
            {
                const u = []
                  , p = i([a, u], o);
                for (const [d,f] of o)
                    (e || !($e(Fe(d)) || $e(Fe(f)))) && u.push([l(d), l(f)]);
                return p
            }
        case _n:
            {
...
const ir = (function(e) {
    ...
    if (typeof e == "function")
        return Je(e);
    if (typeof e == "object")
        return Array.isArray(e) ? Qo(e) : Ko(e);
    if (typeof e == "string")
        return Go(e);
...
function ta(e, n, t, r) {
    let i;
    typeof n == "function" && typeof t != "function" ? (r = t,
    t = n) : i = n;
    const l = ir(i)
      , o = r ? -1 : 1;
    a(e, void 0, [])();
    function a(c, s, u) {
        ...
        function d() {
            let f = lr, S, b, z;
            if ((!n || l(c, s, u[u.length - 1] || void 0)) && (f = ra(t(c, u)),
            f[0] === gt))
                return f;
            if ("children"in c && c.children) {
                ...
                if (k.children && f[0] !== na)
                    ...
                    z = u.concat(k); b > -1 && b < k.children.length; ) {
...
function or(e, n, t, r) {
    let i, l, o;
    typeof n == "function" && typeof t != "function" ? (l = void 0,
    o = n,
    i = t) : (l = n,
    o = t,
    i = r),
...
function la(e, n) {
    ...
    function c(u, p) {
        const d = u.type
          , f = a.handlers[d];
        if (bn.call(a.handlers, d) && f)
            return f(a, u, p);
        if (a.options.passThrough && a.options.passThrough.includes(d)) {
            if ("children"in u) {
                const {children: b, ...z} = u
                  , k = Qe(z);
                return k.children = a.all(u),
                k
            }
            return Qe(u)
        }
    ...
    function s(u) {
        ...
        if ("children"in u) {
            ...
            for (; ++f < d.length; ) {
                const S = a.one(d[f], u);
                if (S) {
                    if (f && d[f - 1].type === "break" && (!Array.isArray(S) && S.type === "text" && (S.value = yt(S.value)),
...
function aa(e, n) {
    ...
    if (e && e.data) {
        ...
        t.type === "element" && l && Object.assign(t.properties, Qe(l)),
...
function pa() {
    ...
    return ln = function c() {
        var s, u, p, d, f, S, b = arguments[0], z = 1, k = arguments.length, A = !1;
        for (typeof b == "boolean" && (A = b,
        b = arguments[1] || {},
        z = 2),
        (b == null || typeof b != "object" && typeof b != "function") && (b = {}); z < k; ++z)
            if (s = arguments[z],
            s != null)
                for (u in s)
                    p = a(b, u),
                    d = a(s, u),
                    b !== d && (A && d && (l(d) || (f = i(d))) ? (f ? (f = !1,
                    S = p && i(p) ? p : []) : S = p && l(p) ? p : {},
                    o(b, {
                        name: u,
                        newValue: c(A, S, d)
...
function da(e, n) {
    ...
    for (; i--; )
        if (e.codePointAt(i) === 47) {
            ...
            o < 0 && (l = !0,
            o = i + 1),
            a > -1 && (e.codePointAt(i) === n.codePointAt(a--) ? a < 0 && (r = i) : (a = -1,
            r = o));
    return t === r ? r = o : r < 0 && (r = e.length),
    e.slice(t, r)
}
function ga(e) {
    if (Ue(e),
...
function Ca(e) {
    if (typeof e == "string")
        ...
        throw n.code = "ERR_INVALID_ARG_TYPE",
        n
    }
    if (e.protocol !== "file:") {
...
class ar {
    ...
    set basename(n) {
        sn(n, "basename"),
        un(n, "basename"),
        this.path = ue.join(this.dirname || "", n)
    }
    get dirname() {
        return typeof this.path == "string" ? ue.dirname(this.path) : void 0
    }
    set dirname(n) {
        wt(this.basename, "dirname"),
        this.path = ue.join(n || "", this.basename)
    }
    get extname() {
...
const Ta = (function(e) {
    ...
    return Object.setPrototypeOf(l, r),
    l
}
)
  , Pa = {}.hasOwnProperty;
class Fn extends Ta {
    ...
    copy() {
        ...
        return n.data(on(!0, {}, this.namespace)),
        n
    }
    data(n, t) {
        return typeof n == "string" ? arguments.length === 2 ? (fn("data", this.frozen),
        this.namespace[n] = t,
        this) : Pa.call(this.namespace, n) && this.namespace[n] || void 0 : n ? (fn("data", this.frozen),
        this.namespace = n,
        this) : this.namespace
    }
    freeze() {
    ...
    run(n, t, r) {
        ...
        return !r && typeof t == "function" && (r = t,
        t = void 0),
    ...
    use(n, ...t) {
        ...
        function o(s) {
            ...
            a(s.plugins),
            s.settings && (i.settings = on(!0, i.settings, s.settings))
        }
        function a(s) {
            let u = -1;
            if (s != null)
...
function Ra(e) {
    const n = e.children || ""
      , t = new ar;
    return typeof n == "string" && (t.value = n),
    t
}
function Ma(e, n) {
    const t = n.allowedElements
      ...
      , c = n.urlTransform || Ba;
    for (const u of Oa)
        Object.hasOwn(n, u.from) && ("" + u.from + (u.to ? "use `" + u.to + "` instead" : "remove it") + va + u.id,
        void 0);
    return or(e, s),
    Yr(e, {
        Fragment: F.Fragment,
    ...
    function s(u, p, d) {
        if (u.type === "raw" && d && typeof p == "number")
            return o ? d.children.splice(p, 1) : d.children[p] = {
                type: "text",
                value: u.value
            },
            p;
        ...
        if (u.type === "element") {
            ...
            if (!f && r && typeof p == "number" && (f = !r(u, p, d)),
            f && d && typeof p == "number")
                return a && u.children ? d.children.splice(p, 1, ...u.children) : d.children.splice(p, 1),
                p
        }
    }
}
...
const Ua = ({content: e, className: n="", breadcrumb: t, title: r, rating: i, totalRatings: l}) => {
    const o = yr()
      , a = u => {
        u && o(u)
    }
    ...
    return e ? F.jsxs("div", {
        ...
        children: [t && t.length > 0 && F.jsx("ol", {
            ...
            components: {
                h1: ({children: u}) => F.jsx("h1", {
                    className: "markdown-h1",
                    children: u
                }),
                h2: ({children: u}) => F.jsx("h2", {
                    className: "markdown-h2",
                    children: u
                }),
                h3: ({children: u}) => F.jsx("h3", {
                    className: "markdown-h3",
                    children: u
                }),
                h4: ({children: u}) => F.jsx("h4", {
                    className: "markdown-h4",
                    children: u
                }),
                h5: ({children: u}) => F.jsx("h5", {
                    className: "markdown-h5",
                    children: u
                }),
                p: ({children: u}) => F.jsx("p", {
                    className: "markdown-p",
                    children: u
                }),
                a: ({href: u, children: p}) => F.jsx("a", {
                    href: u,
                ...
                ul: ({children: u}) => F.jsx("ul", {
                    className: "markdown-ul",
                    children: u
                }),
                ol: ({children: u}) => F.jsx("ol", {
                    className: "markdown-ol",
                    children: u
                }),
                li: ({children: u}) => F.jsx("li", {
                    className: "markdown-li",
                    children: u
                }),
                strong: ({children: u}) => F.jsx("strong", {
                    className: "markdown-strong",
                    children: u
                }),
                em: ({children: u}) => F.jsx("em", {
                    className: "markdown-em",
                    children: u
                }),
                img: ({src: u, alt: p}) => F.jsx("img", {
                    src: u,
                    alt: p || "",
