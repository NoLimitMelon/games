import{r as g,b as D,c as $,h as c,j as s,z as e,i as v,g as u,f as j,ag as C}from"./index-BeQJxy4Y.js";import{g as W,G as H,P as I,A as q,R as L}from"./RelatedCategories-BiBTBYmM.js";import{I as T}from"./InHouseAd-CKmQwvlL.js";/* empty css                */import{B as R}from"./BottomMarkdown-gI6ZmMjA.js";import{L as O}from"./LoadMainGrid-BFKhkTYi.js";import{S as B}from"./SEOHelmet-6BKbwW2j.js";import{u as E}from"./useApps-CqvVgkCR.js";import"./testConts-vN1Nohsa.js";import"./useCategories-CXXzusMi.js";import"./useCurUser-jtoOkFvt.js";import"./Icon-3Q1ZovIG.js";function U(){const[t,f]=g.useState(!1);return g.useEffect(()=>{const i=()=>{f(window.innerWidth<800)};return i(),window.addEventListener("resize",i),()=>window.removeEventListener("resize",i)},[]),t}const ie=()=>{var y;let t=E();const f=(y=D($))==null?void 0:y.Apps,i=U(),[b,k]=g.useState(typeof window<"u"?window.innerWidth:1024);g.useEffect(()=>{const o=()=>k(window.innerWidth);return window.addEventListener("resize",o),()=>window.removeEventListener("resize",o)},[]);const z=c()?"https://www.youtube.com/@freezenova":Math.random()<.5?"https://www.youtube.com/@duckmath-games":"/join-chad.html";if(t=t==null?void 0:t.filter(o=>o.is_listed!==!1),f||!(t!=null&&t.length))return s.jsx(O,{});const F=(o=>{if(!o||o.length===0)return[];const m=C(o),S=m.slice(0,3).map(a=>({...a,size:i?"2x2":"3x3"})),G=m.slice(3,9).map(a=>({...a,size:i?"1x1":"2x2"})),n=[...S,...G],h=m.slice(9).map(a=>({...a,size:"1x1"})),w=Math.min(100,m.length),d=[],p=new Set;p.add(0);const P=Math.floor((w-1)/(n.length-1));for(let a=1;a<n.length;a++)p.add(a*P);let r=0,l=0;for(let a=0;a<w;a++)p.has(a)&&r<n.length?(d.push(n[r]),r++):l<h.length&&(d.push(h[l]),l++);for(;r<n.length;)d.push(n[r]),r++;for(;l<h.length;)d.push(h[l]),l++;return d})(t||[]),N=`##### About DuckMath
...
- [Steal A Brainrot](${e("steal-brainrot-heist")})
- [Run 3](${e("run-3-freezenova")})
- [Backflip Challenge](${e("backflip-challenge")})
- [99 Nights Forest Survival](${e("99-nights-forest-survival")})
- [Highway Traffic](${e("highway-traffic")})
- [Stickman Gta City](${e("stickman-gta-city")})
- [Drift King](${e("drift-king")})
...
DuckMath is a simple, fast, student run unblocked games website. We prioritize stable, lightweight embeds, helpful controls info, and quick links so you can get into a game and have fun. Our goal is to make it easy for students to find and play unblocked games at school.`,x=`##### About DuckMath.Cloud
...
- [Steal A Brainrot Heist](${e("steal-brainrot-heist")})
- [99 Nights In The Forest](${e("99-nights-in-the-forest")})
- [Duckcraft](${e("eagle-duckcraft")})
- [Ragdoll Archers](${e("ragdoll-archers")})
- [Grow A Garden](${e("grow-a-garden")})
- [Race Survival Arena King](${e("race-survival-arena-king")})
...
DuckMath.Cloud is the cloud version of DuckMath, built for speed, accessibility, and fun. It's a community unblocked games site focused on working games, clean layouts, and instant play. Whether you want a quick break or a full session, DuckMath.Cloud makes unblocked gaming simple and enjoyable.`,A=`##### About FreezeNova
...
- [Steal Brainrot Heist](${e("steal-brainrot-heist")})
- [Ragdoll Archers](${e("ragdoll-archers")})
- [Grow A Garden](${e("grow-a-garden")})
- [99 Nights In The Forest](${e("99-nights-in-the-forest")})
- [Race Survival Arena King](${e("race-survival-arena-king")})
...
So, every time you play one of our games, remember that you're not just having fun; you're also part of FreezeNova's big adventure!`,M=v()?W(t,`${u(!1)} - Free Unblocked Games Online`,"Play hundreds of unblocked games free online! No downloads needed. Access your favorite games at school with our collection of unblocked games.",20):null;return s.jsxs("div",{children:[s.jsx(B,{seo:c()?{title:"FreezeNova – Free Online Games ▶️",description:"Play the best free online games on FreezeNova! No downloads, no signups. Handpicked premium browser games for every taste. Play instantly on any device.",keywords:"free online games, browser games, play games online, FreezeNova, no download games"}:{title:`${u(!1)} Unblocked Games`,description:"Play hundreds of unblocked games free online! No downloads needed. Access your favorite games at school with our collection of unblocked games.",keywords:"unblocked games, free games, school games, online games, play games"},regular:c()?{title:`${u(!1)} – Free Online Games ▶️`,description:`Play the best free online games on ${u(!1)}. Handpicked premium browser games, no downloads required.`,keywords:`free online games, browser games, ${u(!1)}, play games online`}:{title:`${u(!1)}`,description:"Browse our collection of study flashcard sets. Learn smarter with spaced repetition and interactive study tools.",keywords:"flashcards, study sets, learning, education, quizlet"},structuredData:M||void 0}),s.jsxs(H,{children:[s.jsx(I,{size:"1x1"}),b>564&&!c()&&s.jsx("li",{className:"egg-vertical-under-pill",children:s.jsx(T,{imageUrl:"/imgs/in_house/discord_vertical.jpg",linkUrl:z,className:"vertical"})}),F.map(o=>s.jsx(q,{title:o.title,icon:o.icon,id:String(o.id),size:o.size,videoUrl:o.video_link},o.id)),s.jsx(L,{})]}),v()&&s.jsx("div",{className:"px-4 pb-8",children:s.jsx(R,{content:c()?A:j()?x:N})})]})};export{ie as default};
